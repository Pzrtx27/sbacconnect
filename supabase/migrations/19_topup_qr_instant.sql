-- ############################################################
-- ##  ห้ามรันไฟล์นี้ซ้ำ — เก็บไว้เป็นบันทึกประวัติเท่านั้น      ##
-- ##                                                        ##
-- ##  ฟังก์ชัน topup_qr_instant() ในไฟล์นี้เชื่อยอดที่ผู้ใช้พิมพ์  ##
-- ##  100% และไม่มีด่านกันยิงซ้ำเลย = เสกเงินได้ไม่จำกัด        ##
-- ##  ถูกแทนที่ด้วย topup_qr_instant_v2() ใน 30_topup_       ##
-- ##  instant_guarded.sql และถูกลบถาวรโดย 36_drop_          ##
-- ##  topup_qr_instant_v1.sql                               ##
-- ##                                                        ##
-- ##  ถ้ารันไฟล์นี้ซ้ำ ช่องโหว่จะกลับมาทันทีโดยไม่มี error       ##
-- ##  ให้รัน 36 ซ้ำอีกครั้งเพื่อปิด                              ##
-- ############################################################
